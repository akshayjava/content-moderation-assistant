    ...
    setupAlarms() {
        try {
            ...
            if (chrome.alarms && chrome.alarms.onAlarm) {
                ...
                console.log('Alarms API setup successfully');
            } else {
                console.warn('Alarms API not available - break reminders disabled');
            }
        } catch (error) {
    ...
    scheduleBreak(duration = 25) {
        try {
            if (chrome.alarms && chrome.alarms.create) {
                ...
                console.log('Break reminder scheduled for', duration, 'minutes');
            } else {
                console.warn('Cannot schedule break - alarms API not available');
            }
        } catch (error) {
