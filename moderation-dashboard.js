    ...
    setupEventListeners() {
        ...
        document.addEventListener('click', (e) => {
            if (e.target.matches('[data-action]')) {
                ...
                const actionId = Number(e.target.getAttribute('data-id'));
...
`;
    ...
    async deleteAction(actionId) {
        try {
            ...
            this.actions = this.actions.filter(a => a.id !== Number(actionId));
    ...
    selectAll() {
        ...
        checkboxes.forEach(cb => {
            ...
            const actionId = Number(cb.dataset.actionId);
            if (cb.checked) {
    ...
    updateSelectedActions() {
        ...
        actionItems.forEach(item => {
            const actionId = Number(item.dataset.actionId);
